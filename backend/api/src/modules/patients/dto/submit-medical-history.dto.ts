import { IsString, IsDateString, IsArray, ValidateNested, IsNotEmpty, IsOptional } from 'class-validator';
...
export class MedicalHistoryAnswerDto {
    ...
    @ApiProperty({ 
        example: 'Yes', 
        description: 'Answer can be string or array of strings for checkbox questions',
        oneOf: [
            { type: 'string' },
