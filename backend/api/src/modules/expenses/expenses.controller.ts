...
export class ExpensesController {
    ...
    async create(
        ...
        const data = await this.expensesService.create(createDto, user.orgId, user.sub);
    ...
    async findAll(
        ...
        const result = await this.expensesService.findAll(user.orgId, query);
        return new StandardResponse({ data: result.data, meta: result.meta }, 'Expenses retrieved successfully');
    }
    ...
    async getTotalByDoctor(
        ...
        return new StandardResponse(data, 'Doctor expenses calculated successfully');
    }
    ...
    async findOne(
        ...
        const data = await this.expensesService.findOne(id, user.orgId);
    ...
    async update(
        ...
        const data = await this.expensesService.update(id, updateDto, user.orgId);
