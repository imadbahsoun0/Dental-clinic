...
export class TreatmentsController {
    ...
    async create(
        ...
        const result = await this.treatmentsService.create(createTreatmentDto, user.orgId, user.id);
    ...
    async findAll(
        ...
        return new StandardResponse({ data: result.data, meta: result.meta }, 'Treatments retrieved successfully');
    }
    ...
    async getPatientStats(
        ...
        const stats = await this.treatmentsService.getPatientTreatmentStats(patientId, user.orgId);
    ...
    async findOne(
        ...
        const result = await this.treatmentsService.findOne(id, user.orgId, user.id, user.role);
    ...
    async update(
        ...
        const result = await this.treatmentsService.update(id, updateTreatmentDto, user.orgId, user.id, user.role, user.id);
    ...
    async remove(
        ...
        await this.treatmentsService.remove(id, user.orgId, user.id, user.role, user.id);
