...
export class TreatmentTypesController {
    ...
    async createCategory(
        ...
        const result = await this.treatmentTypesService.createCategory(createDto, user.orgId);
    ...
    async findAllCategories(@CurrentUser() user: CurrentUserData) {
        const result = await this.treatmentTypesService.findAllCategories(user.orgId);
    ...
    async updateCategory(
        ...
        const result = await this.treatmentTypesService.updateCategory(id, updateDto, user.orgId);
    ...
    async createType(
        ...
        const result = await this.treatmentTypesService.createType(createDto, user.orgId);
    ...
    async updateType(
        ...
        const result = await this.treatmentTypesService.updateType(id, updateDto, user.orgId);
