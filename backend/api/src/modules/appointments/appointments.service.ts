...
export class AppointmentsService {
  ...
  async create(
    ...
    const appointment = this.em.create(Appointment, {
      ...
      treatmentType: createDto.treatmentTypeId
  ...
  async update(
    ...
    const { patientId, treatmentTypeId, doctorId, treatmentId, ...updateData } =
      updateDto;
    ...
    if (treatmentTypeId) {
      appointment.treatmentType = this.em.getReference(
        'TreatmentType',
        treatmentTypeId,
      ) as any;
    }
