...
export class FilesService {
    ...
    constructor(
        ...
        this.bucketName = this.configService.get('AWS_S3_BUCKET') || 'dentil-clinic-dev';
    }

    async uploadFile(file: Express.Multer.File, orgId?: string, createdBy?: string): Promise<Attachment> {
